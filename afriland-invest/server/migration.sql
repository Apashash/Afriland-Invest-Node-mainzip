-- ================================================================
-- AFRILAND INVEST - Migration complète (safe, sans perte de données)
-- Exécuter dans : Supabase Dashboard > SQL Editor
-- Ce script est idempotent : peut être relancé plusieurs fois
-- ================================================================
...
ALTER TABLE utilisateurs ADD COLUMN IF NOT EXISTS parrain_id INT REFERENCES utilisateurs(id);
...
-- ── Plans d'investissement par défaut ───────────────────────────
